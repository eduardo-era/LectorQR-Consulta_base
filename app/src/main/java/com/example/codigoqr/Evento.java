...
public class Evento
{
    ...
    public Evento (int Id_evento,String Nombre_evento,String Tipo_evento,String Fecha_inicio,String Fecha_termino,String Nac_int,String Lugar,String Col_org)
    {
    ...
    {
        return Nombre_evento.replace('_',' ');
    }
}
